...
//             <div className="flex gap-4">
//               {[Twitter, Facebook, Instagram, Linkedin].map((Icon, i) => (
//                 <a key={i} href="#" className="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-gold-400 hover:text-gold-400 transition-all duration-300 text-white">
//                   <Icon className="w-4 h-4" />
//                 </a>
//               ))}
//             </div>
...
//               {['Features', 'Security', 'Enterprise', 'Pricing'].map((item) => (
//                 <li key={item}>
//                   <a href="#" className="hover:text-white transition-colors block py-1">{item}</a>
//                 </li>
//               ))}
//             </ul>
//           </div>
...
//               {['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'Licenses'].map((item) => (
//                 <li key={item}>
//                   <Link href={`/${item.toLowerCase()}`} passHref legacyBehavior></Link>
//                   <a className="hover:text-white transition-colors block py-1"></a>
//                   <a href="#" className="hover:text-white transition-colors block py-1">{item}</a>
//                 </li>
//               ))}
//             </ul>
...
//                 className="bg-transparent border-b border-white/20 py-3 text-sm text-white focus:outline-none focus:border-gold-400 w-full placeholder-gray-700 font-sans tracking-wide"
//               />
//               <button className="absolute right-0 top-3 text-white hover:text-gold-400 transition-colors">
//                 <ArrowUpRight className="w-4 h-4" />
//               </button>
//             </div>
//           </div>
