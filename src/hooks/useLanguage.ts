     ...
     "dashboard.current.lastUpdated": "Last Updated",
      ...
      "dashboard.metrics.bleSeen.columns.samples": "Samples",
       ...
       "dashboard.metrics.bleTop.title": "Bluetooth Devices Most Time Nearby",
        ...
        "dashboard.metrics.bleTop.columns.select": "Select",
        "dashboard.metrics.bleTop.mapButton": "Map where seen",
        "dashboard.metrics.bleTop.mapButton.loading": "Loading map…",
        "dashboard.metrics.bleTop.mapTitle": "Where this Bluetooth device was seen",
        "dashboard.metrics.bleTop.mapEmpty": "No locations found yet for this device.",
        "dashboard.metrics.bleTop.range.label": "Filter by time range",
        "dashboard.metrics.bleTop.range.from": "From",
        "dashboard.metrics.bleTop.range.to": "To",
        "dashboard.metrics.bleTop.sessionsTitle": "Sessions where this device appears",
        "dashboard.metrics.bleTop.sessions.columns.session": "Session",
        "dashboard.metrics.bleTop.sessions.columns.sightings": "Sightings",
        "dashboard.metrics.bleTop.sessions.columns.multiPlace": "Moves >20 m",
        "dashboard.metrics.bleTop.sessions.multiPlace.yes": "Yes",
        "dashboard.metrics.bleTop.sessions.multiPlace.no": "No",
      ...
      "dashboard.metrics.bleSeen.columns.address": "Dirección",
       "dashboard.metrics.bleSeen.columns.samples": "Muestras",
        ...
        "dashboard.metrics.bleTop.title": "Dispositivos Bluetooth más tiempo cerca",
         ...
         "dashboard.metrics.bleTop.columns.select": "Elegir",
         "dashboard.metrics.bleTop.mapButton": "Mapa donde se vio",
         "dashboard.metrics.bleTop.mapButton.loading": "Cargando mapa…",
         "dashboard.metrics.bleTop.mapTitle": "Dónde se ha visto este dispositivo Bluetooth",
         "dashboard.metrics.bleTop.mapEmpty": "Todavía no hay ubicaciones para este dispositivo.",
         "dashboard.metrics.bleTop.range.label": "Filtrar por intervalo de tiempo",
         "dashboard.metrics.bleTop.range.from": "Desde",
         "dashboard.metrics.bleTop.range.to": "Hasta",
         "dashboard.metrics.bleTop.sessionsTitle": "Sesiones donde aparece este dispositivo",
         "dashboard.metrics.bleTop.sessions.columns.session": "Sesión",
         "dashboard.metrics.bleTop.sessions.columns.sightings": "Avistamientos",
         "dashboard.metrics.bleTop.sessions.columns.multiPlace": "Movimientos >20 m",
         "dashboard.metrics.bleTop.sessions.multiPlace.yes": "Sí",
         "dashboard.metrics.bleTop.sessions.multiPlace.no": "No",
