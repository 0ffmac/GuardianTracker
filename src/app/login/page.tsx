...
export default function LoginPage() {
  ...
  const oauthError = (() => {
    switch (errorParam) {
      ...
      case "EmailMissing":
        return "Your OAuth provider did not return an email. Please use email/password sign up first.";
      case "DomainNotAllowed":
        return "Your Google account domain is not allowed for sign-in.";
      default:
        return "";
    }
  })();
  ...
  useEffect(() => {
    // Discover enabled providers from NextAuth
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8">
          ...
          {/* OAuth Buttons (only if configured) */}
